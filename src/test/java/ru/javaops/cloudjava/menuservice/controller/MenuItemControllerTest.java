...
public class MenuItemControllerTest extends BaseTest {
    ...
    @Test
    void getMenuItem_returnsMenuItem() {
        var id = getIdByName("Cappuccino");
        webTestClient.get()
                .uri(BASE_URL + "/" + id)
                .accept(MediaType.APPLICATION_JSON)
    ...
    @Test
    void getMenuItems_returnsEmptyList_whenNoItemInCategory() {
        webTestClient.get()
                .uri(uriBuilder -> uriBuilder
                        .path(BASE_URL)
                        .queryParam("category", Category.DINNER.toString())
    ...
    @Test
    void getMennuItems_returnsMenuItemsList() {
        webTestClient.get()
                .uri(uriBuilder -> uriBuilder
                        .path(BASE_URL)
                        .queryParam("category", Category.DRINKS.toString())
                        .queryParam("sort", SortBy.AZ)
                        .build())
                .accept(MediaType.APPLICATION_JSON)
                .exchange()
